...
def test_oauth():
    ...
    try:
        ...
        stdin, stdout, stderr = client.exec_command(
            "cd /root/leetcode_tracker_uv/leetcode_tracker_uv && /root/.local/bin/uv pip list | grep authlib"
        )
        print(stdout.read().decode())
        ...
        print("\n=== Recent error logs ===\n")
        stdin, stdout, stderr = client.exec_command(
            "tail -50 /root/leetcode_tracker_uv/leetcode_tracker_uv/server.log | grep -i error"
        )
