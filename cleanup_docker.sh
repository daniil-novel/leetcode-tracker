...
echo "Port 9091 (occupied by external Node.js process - PID 1215):"
sudo netstat -tulpn | grep :9091 || echo "  ✅ Port 9091 is free"
echo "Port 9092 (occupied by external outline-ss-ser process):"
sudo netstat -tulpn | grep :9092 || echo "  ✅ Port 9092 is free"
echo "Port 9093 (Prometheus - FINAL):"
sudo netstat -tulpn | grep :9093 || echo "  ✅ Port 9093 is FREE - READY TO USE"
