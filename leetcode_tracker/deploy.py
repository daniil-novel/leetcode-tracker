...
def main() -> None:
    ...
    try:
        ...
        grafana_cmd = (
            ...
            "-e GF_INSTALL_PLUGINS='https://github.com/fr-ser/grafana-sqlite-datasource/releases/download/v2.2.1/fr-ser-sqlite-datasource-2.2.1.zip;fr-ser-sqlite-datasource' "
            "-e GF_PLUGINS_ALLOW_LOADING_UNSIGNED_PLUGINS=fr-ser-sqlite-datasource "
