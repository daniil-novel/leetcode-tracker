...
def get_or_create_user(
    oauth_provider: str, oauth_id: str, email: str | None, username: str, avatar_url: str | None, db: Session
) -> models.User:
    ...
    user = models.User(
        username=username, email=email, oauth_provider=oauth_provider, oauth_id=oauth_id, avatar_url=avatar_url
    )
    db.add(user)
    db.commit()
    db.refresh(user)
